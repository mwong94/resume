...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{Reddit Front Page Predictor}
      {A two part project: (1) Reddit crawler to collect time series data on all posts
      in specified subreddits and (2) Machine Learning model to predict whether or not
      a post will eventually make it to the frontpage. \\
  ...
  \resumeSubHeadingListStart
    ...
    \item{
      \textbf{Operating Systems Experience}{:  \resumeSubHeadingListStart
                                    \item{MacOS, Windows, UNIX}
                                    \item{Extensive experience with Debian, RedHat families}
                                    \item{Virtualization: QEMU, KVM, Xen, Proxmox}
                                  \resumeSubHeadingListEnd}
    }
...
\section{Other}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Additive Manufacturing}{June 2016 -- Present}
      {FDM/DLP 3D printing}{}
      \resumeItemListStart
