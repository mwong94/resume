...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Data Structure Implementation and Analysis [A-]}{Design and
          implementation of data structures in C++.}
        \resumeItem{Computer Simulation [A]}{Time and event based simulations.}
        \resumeItem{Machine Learning and Data Mining [A]}{Broad coverage of
          different regression and classification algorithms.}
        \resumeItem{Data Management and Project in Web Apps [A/A-]}{MySQL database management
          and full stack development of a Tomcat web app.}
        \resumeItem{Project in Data Science [A/IP]}{Senior capstone project.}
      \resumeItemListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Independent Research Intern}{January 2013 -- June 2015}
      \resumeItemListStart
        \resumeItem{Magnetic Resonance Fingerprinting}
          ...
          Presented my findings and an abstract at ISMRM 2014.}
        \resumeItem{Kernel based image reconstruction}
          {Implemented a kernel based MR image reconstruction algorithm using OpenCL for parallelization.}
      \resumeItemListEnd
      \resumeSubheading
